...
urlpatterns = [
    ...
    path("changer-etape/annule/", changement_etape.classer_le_dossier_comme_annule, name="classer_comme_annule_url"),
    ...
    path("changer-etape/annule-declaration-manifestations/", declaration_manifestations.declaration_manifestations_classer_comme_annule, name="declaration_manifestations_classer_comme_annule_url"),
