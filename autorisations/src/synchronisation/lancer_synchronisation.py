...
"""
Ce fichier est executé en arrière plan lorsqu'on lance une synchronisation complète.
Afin de corriger d'éventuels différences entre Démarche Numérique, Déclaration Manifestations et notre appli !
"""
...
try:
    ...
    from synchronisation.main import lancer_normalisation_et_synchronisation
...
# Pour le dev : Interruption manuelle de la synchro
